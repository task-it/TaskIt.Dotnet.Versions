...
namespace TaskIt.Dotnet.Versions.Options
{
    ...
    {
        [Option('v', "newVersion", Required = false, HelpText = "the pattern to modify the original version. Wildcards ('*') are possible and will nnot modify the original version.")]
